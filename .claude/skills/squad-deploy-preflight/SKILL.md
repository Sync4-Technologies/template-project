...
- DevOps spec: `.claude/squad/template/agents/devops-engineer.md` → "Verificação Ativa de Deploy" e "Padrões PaaS + Docker"
- Self-review: `.claude/squad/template/docs/engineer-self-review.md` → §0 (gate docker fiel)
- Stack gotchas: `.claude/squad/template/docs/stack-conventions/backend/nodejs.md` → "Deployment & runtime gotchas"
