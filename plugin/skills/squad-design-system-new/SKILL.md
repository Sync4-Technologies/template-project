...
Ler `${CLAUDE_PLUGIN_ROOT}/template/docs/design-system/external-repos.md` para identificar se o DS escolhido tem repo externo suportado pela squad.
...
1. Copiar `${CLAUDE_PLUGIN_ROOT}/template/docs/design-system/source.md.template` para `.claude/squad/project/design-system/source.md`
...
Popular estrutura completa conforme `${CLAUDE_PLUGIN_ROOT}/template/docs/design-system/README.md`:
...
- ADR-005 (DS default): `${CLAUDE_PLUGIN_ROOT}/template/memory/ADR/ADR-005-design-system.md`
- Estrutura do DS doc: `${CLAUDE_PLUGIN_ROOT}/template/docs/design-system/README.md`
