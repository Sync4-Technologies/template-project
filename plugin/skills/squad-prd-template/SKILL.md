...
> **Owner:** Product Owner | **Revisão:** 90 dias | **Obsolescência:** template `${CLAUDE_PLUGIN_ROOT}/template/docs/PRD-template.md` removido ou substituído
...
- Template: `${CLAUDE_PLUGIN_ROOT}/template/docs/PRD-template.md`
- Regras do PO: `${CLAUDE_PLUGIN_ROOT}/template/agents/product-owner.md`
