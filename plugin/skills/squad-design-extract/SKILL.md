...
Consultar `${CLAUDE_PLUGIN_ROOT}/template/docs/design-system/external-repos.md` para verificar se o DS inferido tem repo externo suportado pela squad.
...
- DS doc template: `${CLAUDE_PLUGIN_ROOT}/template/docs/design-system/README.md`
