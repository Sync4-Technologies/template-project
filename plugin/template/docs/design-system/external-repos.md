...
Ver `${CLAUDE_PLUGIN_ROOT}/template/docs/design-system/source.md.template` para template de `source.md` no projeto.
...
- Source template: `${CLAUDE_PLUGIN_ROOT}/template/docs/design-system/source.md.template`
- DS index (no projeto): `${CLAUDE_PLUGIN_ROOT}/template/docs/design-system/README.md`
- Product Designer spec: `${CLAUDE_PLUGIN_ROOT}/template/agents/product-designer.md`
