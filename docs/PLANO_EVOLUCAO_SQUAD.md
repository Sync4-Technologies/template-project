...
| 2.7 | ~~UP-14: plugin-ci duplicava suite em PR com head develop/main~~ — **implementado em `develop` (PR #52, 2026-07-28)**, `push` restrito a `main`; entra em main na próxima release; prova de efeito = 1 suite no próximo PR `develop→main` |
...
| 3.3 | ~~ADR-005: remover argumentação obsoleta do Material 3 web~~ — **implementado em `develop` (PR #52, 2026-07-28)**, entra em main na próxima release: racional reescrito para default-por-plataforma; "A1 shadcn rejeitado" removida (contradizia a v2); trade-offs/consequências/critérios realinhados (218→~170 linhas) |
