...
4. ~~**Sem via rápida para tarefa trivial**~~ — **RESOLVIDO (2026-07-30, item 2.3)**: fast lane com critério objetivo em `tech-lead.md` §3b.
...
| 2.3 | ~~**Fast lane no TL**~~ — **FEITO (2026-07-30)**: `tech-lead.md` §3b, critério de 4 itens todos obrigatórios + o que NÃO se dispensa (gate, CR, falha-antes/passa-depois). Exceção registrada no DoD (squad-core §K) para as duas fontes não se contradizerem |
| 2.4 | ~~Qualificar "feature crítica" com materialidade~~ — **FEITO (2026-07-30)**: tabela de 4 eixos com contra-exemplo em cada + regra de desempate pelo dano concreto. Lista duplicada no ADR-003 virou ponteiro (padrão de desperdício #3) |
| 2.5 | ~~M0: propor delegação de merge junto com a proposta do M0~~ — **FEITO (2026-07-30)**: `tech-lead.md` §2, junto ao parágrafo do M0 |
